...
st.set_page_config(page_title="반려견 영양 연구소 계산기 v5.7", layout="wide")
st.title("🐶 반려견 영양 연구소 [생식 계산기 v5.7]")
st.info("💡 전문가용 맞춤형 영양 컨설팅 & 레시피 분석 시스템 | v5.7: 소목뼈·캥거루사태·오리울대·아몬드가루·햄프씨드·호박씨가루·크랜베리·케일·아스파라거스·고등어·굴/홍합(익힘) 추가")
