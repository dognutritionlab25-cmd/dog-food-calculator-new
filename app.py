...
st.set_page_config(page_title="반려견 영양 연구소 계산기 v6.0", layout="wide")
st.title("🐶 반려견 영양 연구소 [영양 계산기 v6.0]")
st.info("💡 전문가용 맞춤형 영양 컨설팅 & 레시피 분석 시스템 | v6.0: 화식 계산기 추가 (생식/화식 통합)")
