...
st.set_page_config(page_title="반려견 영양 연구소 계산기 v5.3", layout="wide")
st.title("🐶 반려견 영양 연구소 [생식 계산기 v5.3]")
st.info("💡 전문가용 맞춤형 영양 컨설팅 & 레시피 분석 시스템 | v5.3: 칠면조가슴살·오리가슴살·염소고기·양고기·열빙어·산양유케피어·초록홍합 추가")
