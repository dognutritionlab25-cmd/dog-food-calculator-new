...
st.set_page_config(page_title="반려견 영양 연구소 계산기 v5.4", layout="wide")
st.title("🐶 반려견 영양 연구소 [생식 계산기 v5.4]")
st.info("💡 전문가용 맞춤형 영양 컨설팅 & 레시피 분석 시스템 | v5.4: 돼지안심·양간·꿩·토끼고기·치아씨드·메추리알·연어 추가")
